...
namespace <NAMESPACE>
    ...
    public partial class <StructureName>Controller extends ApiController
        ...
        proc
            ...
            if (dataRepository.Read(<PRIMARY_KEY><SEGMENT_LOOP>a<SegmentName>,</SEGMENT_LOOP></PRIMARY_KEY><structureName>Obj) == RepositoryResult.NotFound)
                mreturn Request.CreateResponse(HttpStatusCode.NotFound)
        ...
        proc
            ...
            if (dataRepository.ReadBy<KEY_NAME>(<SEGMENT_LOOP>a<SegmentName>,</SEGMENT_LOOP>results) == RepositoryResult.NotFound)
                mreturn Request.CreateResponse(HttpStatusCode.NotFound)
        ...
        proc
            if (dataRepository.Create(<structureName>Obj) == RepositoryResult.Exists)
        ...
        proc
            if (dataRepository.Delete(<PRIMARY_KEY><SEGMENT_LOOP>a<SegmentName><,></SEGMENT_LOOP></PRIMARY_KEY>) == RepositoryResult.NotFound)
                mreturn Request.CreateResponse(HttpStatusCode.NotFound)
