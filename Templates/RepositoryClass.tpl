...
namespace <NAMESPACE>
    ...
    public partial class <StructureName>Repository implements I<StructureName>Repository
        ...
        proc
            data <structureName>Rec, str<StructureName>
            foreach <structureName>Rec in new Select(new From(fileSpec,<structureName>Rec),(NoCaseWhere)(<PRIMARY_KEY><SEGMENT_LOOP>(<structureName>Rec.<segment_name>==a<SegmentName>)<&&></SEGMENT_LOOP></PRIMARY_KEY>))
            begin
